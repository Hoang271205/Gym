...
public class MainActivity extends AppCompatActivity {
    ...
    private List<WorkoutCard> workoutList;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            CardView twistCard = findViewById(R.id.cardTwist);
            twistCard.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            workoutList.add(new WorkoutCard("Push-ups", "4 sets of 10 reps", 50, pushupBitmap,PushupDetailsActivity.class,"Chest"));
            workoutList.add(new WorkoutCard("Running", "5 km run", 300, RunningBitmap, RunningDetailsActivity.class,"Stamina"));
            workoutList.add(new WorkoutCard("Plank", "Hold for 1 minute", 30, PlankBitmap, PlankDetailsActivity.class,"Core"));
